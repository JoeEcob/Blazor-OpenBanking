namespace Spendy.Data.Loaders
{
    ...
    public class AccountLoader(AuthService authService, TrueLayerAPI trueLayerApi, IDatastore dataStore, ProviderService providerService, ILogger<AccountLoader> logger)
